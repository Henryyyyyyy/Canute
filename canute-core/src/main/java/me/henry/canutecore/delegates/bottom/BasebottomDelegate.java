...
import me.henry.canutecore.R2;
import me.henry.canutecore.delegates.CanuteDelegate;
import me.yokeyword.fragmentation.ISupportFragment;

/**
 * Created by henry on 2017/9/4.
 * 1。这里的抽象方法是为了约束子类，然后在子类获取相应的数据再在这里进行处理
 */

public abstract class BasebottomDelegate extends CanuteDelegate implements View.OnClickListener {
