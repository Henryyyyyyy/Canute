package me.henry.canutecore.ui.animation;
...
import me.henry.canutecore.ui.dimen.ScreenUtils;

public final class BezierAnimation {

    public static void addCart(CanuteDelegate delegate, View start, View end,
