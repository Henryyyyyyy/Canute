package me.henry.canuteec.main.sort.list;
...
public class SortRecyclerAdapter extends MultipleRecyclerAdapter {
    ...
    private void switchContent(ContentDelegate delegate) {
        final CanuteDelegate contentDelegate = SupportHelper.findFragment(DELEGATE.getChildFragmentManager(), ContentDelegate.class);
