...
public class SearchDelegate extends CanuteDelegate {
    ...
    private void saveItem(String item) {
        if (!StringUtils.isEmpty(item) && !StringUtils.isSpace(item)) {
            ...
            final String historyStr =
                    CanutePreference.getCustomAppProfile(SearchDataConverter.TAG_SEARCH_HISTORY);
            ...
            CanutePreference.addCustomAppProfile(SearchDataConverter.TAG_SEARCH_HISTORY, json);
        }
    }
