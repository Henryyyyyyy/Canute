...
import me.henry.canutecore.ui.animation.BezierAnimation;
import me.henry.canutecore.ui.animation.BezierUtil;
import me.henry.canutecore.ui.banner.HolderCreator;
import me.henry.canutecore.ui.widget.CircleTextView;
...
public class GoodsDetailDelegate extends CanuteDelegate implements AppBarLayout.OnOffsetChangedListener,BezierUtil.AnimationListener{
    ...
    public void onAnimationEnd() {
        ...
        RestClient.builder()
                ...
                .success(new ISuccess() {
                    @Override
                    public void onSuccess(String response) {
                        CanuteLogger.json("ADD", response);
